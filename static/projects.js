projects={
    ...
    project2:{
        ...
        •Later, the SFT-tuned model is re-tuned using RLHF (Reinforcement learning from human feedback) using our own Human Preferences, resulting 19.5 Pass@1 and 44.2 Pass@100 on the HumanEval benchmark.`,
